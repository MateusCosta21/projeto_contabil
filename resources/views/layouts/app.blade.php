            ...
            <div class='dashboard'>
                <div class="dashboard-nav">
                    ...
                    <nav class="dashboard-nav-list">
                        <a href="{{ route('home') }}" class="dashboard-nav-item"><i class="fas fa-tachometer-alt"></i>
                        ...
                        <div class='dashboard-nav-dropdown'>
                            ...
                            <div class='dashboard-nav-dropdown-menu'>
                                ...
                                <a href="{{ route('tipo_objeto') }}" class="dashboard-nav-dropdown-item">Tipos de
                                    objeto</a>
